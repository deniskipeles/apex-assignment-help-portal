import { apex } from '@/src/store/useStore';
...
export default function Footer() {
  ...
  const credits = [
    ...
    {
      name: 'EduSolve',
      url: 'https://github.com/deniskipeles/apex-assignment-help-portal',
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg overflow-hidden transform -rotate-6 shadow-[0_0_10px_rgba(204,255,0,0.2)] flex-shrink-0">
            ...
            <img src={`${apex.baseUrl}/logo`} alt="EduSolve" className="w-full h-full object-cover" />
          </div>
          <div>
            <span className="font-display font-bold text-sm text-ink-invert">EduSolve</span>
        ...
        <div className="flex items-center gap-4 text-xs text-gray-500">
          <a href="https://deniskipeles.is-a.dev" target="_blank" rel="noreferrer noopener" className="hover:text-neon transition-colors">
            MIT License
          </a>
          {/* <span>·</span>

...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 bg-slate-50/50" id="auth_page_container">
      <div className="w-full max-w-lg bg-white rounded-3xl border border-slate-200/80 shadow-xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-6 sm:p-8 space-y-6">
          <div className="flex flex-col text-center md:text-left">
            <h2 className="text-2xl font-extrabold text-slate-800 heading-font tracking-tight">
            ...
            <div className="bg-slate-50 border border-slate-200/50 p-3 rounded-2xl space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="bg-white border border-slate-200/60 hover:bg-slate-100 py-1.5 rounded-xl text-[11px] font-bold text-slate-700 cursor-pointer transition-colors"
                >
                  Student Account
                </button>
                <button
          ...
          {error && (
            <div className="p-3 bg-rose-50 border border-rose-200 text-xs font-semibold text-rose-700 rounded-xl leading-normal text-center">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {isRegistering && (
              <>
                ...
                {role === 'tutor' && (
                  <div className="bg-slate-50 border border-slate-100 p-4 rounded-2xl space-y-3.5 mt-2 animate-fade-in">
                    <span className="text-[10px] text-sky-600 font-bold uppercase tracking-wider block">Tutor Credentials Settings</span>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-white border border-slate-200 focus:border-sky-500 pl-10 pr-4 py-2 rounded-xl outline-none text-xs text-slate-800 transition-all font-semibold"
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-white border border-slate-200 focus:border-sky-500 pl-10 pr-4 py-2 rounded-xl outline-none text-xs text-slate-800 transition-all"
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        className="w-full bg-white border border-slate-200 focus:border-sky-500 pl-10 pr-4 py-2 rounded-xl outline-none text-xs text-slate-800 transition-all resize-none"

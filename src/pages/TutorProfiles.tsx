  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" id="tutor_profiles_page">
      ...
      <div className="text-center md:text-left space-y-2 mb-8">
        <span className="text-[10px] bg-sky-50 border border-sky-200 text-sky-700 px-3 py-1 rounded-full font-bold uppercase tracking-wider inline-block">
      ...
      <div className="bg-white border border-slate-200/80 p-4 rounded-2xl shadow-sm mb-8 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
        ...
        <div className="md:col-span-5 relative">
          <input
            ...
            className="w-full bg-slate-50 border border-slate-200 focus:border-sky-500 focus:bg-white pl-10 pr-4 py-2.5 rounded-xl outline-none text-xs text-slate-800 transition-all"
        ...
        <div className="md:col-span-3 relative">
          <select
            ...
            className="w-full bg-slate-50 border border-slate-200 focus:border-sky-500 focus:bg-white px-3.5 py-2.5 rounded-xl outline-none text-xs text-slate-800 transition-all cursor-pointer"
          >
            <option value="">All Subject Expertise</option>
            {courses.map((course) => (
            ...
            <option value="Calculus">Calculus wiz</option>
          </select>
        </div>

        {/* Price Slider */}
        <div className="md:col-span-4 flex items-center gap-3 bg-slate-50 border border-slate-200 px-3.5 py-1.5 rounded-xl">
          <div className="flex-1">
            <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wider block leading-none">Max hourly rate</span>
            <input
              type="range"
              min="20"
              max="60"
              ...
              className="w-full h-1 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-sky-600 mt-2"
            />
          </div>
          <span className="font-bold text-slate-800 text-xs shrink-0 bg-white border border-slate-200 px-2.5 py-1 rounded-lg">
            ${maxHourlyRate}/hr
          </span>
        </div>
      ...
      {filteredTutors.length === 0 ? (
        <div className="text-center py-20 bg-white border border-slate-200 rounded-3xl shadow-sm">
          ...
          <h4 className="font-bold text-slate-800 text-base heading-font">No Matching Tutors Found</h4>
